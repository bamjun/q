...
echo "docker rmi $(docker images -q) || true"
echo "docker rmi -f $(docker images -q) || true"
echo "yes | docker system prune -a || true"
echo "yes | docker volume prune || true"
echo "yes | docker builder prune || true"
echo "docker volume rm $(docker volume ls -q) || true"